...
void VulkanEngine::init_descriptors(){
    ...
    //  ake the descriptor set layout for the global uniform buffer
    {
        DescriptorLayoutBuilder builder;
 ...
 */
	...
	glm::mat4 view = glm::translate(glm::vec3{ 0,0,-5 });
	// camera projection
	glm::mat4 projection = glm::perspective(glm::radians(70.f), (float)_drawExtent.width / (float)_drawExtent.height, 0.1f, 200.f);
...
void GLFTMetallic_Roughness::build_pipelines(VulkanEngine* engine){
