...
namespace Pipeline{
    vk::raii::Pipeline createGraphicsPipeline(Engine &engine, PipelineInfo *p_info, std::string v_shader, std::string f_shader, bool is_transparent, vk::CullModeFlagBits cull_mode);
